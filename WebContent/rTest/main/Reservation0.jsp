...
<%
	...
	*/
	...
	String price				= (String)request.getAttribute("price");													// 상품가격(특수기호 제외, 가맹점에서 직접 설정)
	...
	/* 기타 */
	String siteDomain = "http://localhost:8080/webProjectTest/INIpayStdSample"; //가맹점 도메인 입력
