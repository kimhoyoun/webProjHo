...
<link rel="stylesheet" href="/readytoplay/css/lesson_soc_detail.css">
<style>
...
<div id="main_wrap">
	<div>
	    <h2 id="main_title">축구 레슨 상세보기</h2>
	</div>
	<hr>
                    ...
                    <td rowspan="3" id="img_area">
                        <div id="visual_wrap">
	                        <c:forTokens items ="${dto.img }" delims = "," var = "ee" varStatus="no">
								<img src="<c:url value="/uploadFile/lesson/soc/${ee}"/>" alt="" style="width: 150px; height: 150px;"/>
							</c:forTokens>
                        </div>
                    </td>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
      ...
      function showModalWindow(index) {
        ...
        /* 요기요 */
        overLayer.innerHTML = "<img src='/proj_04_minsoo/main/uploadFile/lesson_soc" + (index + 1) + ".jpg'>"
        overLayer.innerHTML = "<img src='/proj_04_minsoo/main/uploadFile/lesson_soc" + (index + 1) + ".jpg'>"
