...
td.modiNdel {
   ...
   <div id="main_wrap">
       <div>
           <h2 id="main_title">농구 대회 게시글 수정</h2>
       </div>
       <hr>
       <div id="commu_bas_compet_detail">
           <table class="table">
               ...
               <tr>
               		<td class="head"><input type="text" name="head" value="${dto.head }"/></td>
                   <td class="title" colspan="3"><input type="text" name="title" value="${dto.title }"/></td>
               </tr>
               <tr>
               ...
               <tr>
                   ...
                   <td class="modiNdel" colspan="2">
                   	<a href="<c:url value="/commu_bas/compet/Detail?post_id=${dto.post_id }&page=${nowPage }"/>"><button type="button">뒤로</button></a>
