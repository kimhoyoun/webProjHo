    ...
    <div class="container border border-3 rounded">
        <div class="row">
          <div class="container text-center" id="img_big">
              <img src="<c:url value="/uploadFile/gym/soccer/${fn:split(dto.img, ',')[0]}"/>" alt="${dto.sname }" style="width: 980px; height: 600px;">
          </div>
          <div id="img_sm" style="margin-top:20px; height:250px; white-space:nowrap; overflow: auto;">
            <c:forTokens items ="${dto.img }" delims = "," var = "imagedata" varStatus="no">
	            <img src="<c:url value="/uploadFile/gym/soccer/${imagedata}"/>" alt="" style="width: 200px; height: 200px;">
			</c:forTokens>
          </div>
        </div>
        ...
        <div class="row" style="margin-top:20px; padding-left: 30px; padding-right:50px">
          <div class="col text-end fs-3 fw-bold">
            <input class="text-center" type="text" name="dateSet" id="dateSet" class="ts" autocomplete="off" value="${param.dateSet }" readonly/>
            <script>
					var setDate=null;
					$(function(){
						$('#dateSet').datepicker({
