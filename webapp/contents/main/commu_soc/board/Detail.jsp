...
.contentBR {
    ...
    <div id="main_wrap">
        <div>
            <h2 id="main_title">축구 자유게시판 상세보기</h2>
        </div>
        <hr>
            ...
            <table class="table">
                ...
                <tr>
                    <td class="img" colspan="4">
						...
						<c:forTokens items ="${dto.img }" delims = "," var = "ee" varStatus="no">
							<img src="<c:url value="/uploadFile/commu/soc/board/${ee}"/>" alt="" style="width: 300px; height: 300px;" />
						</c:forTokens>
						</c:if>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="modiNdel" colspan="2">
                    	<a href="<c:url value="/commu_soc/board/ModifyForm?post_id=${dto.post_id }&page=${nowPage }"/>"><button>수정</button></a>
                    	<a href="<c:url value="/commu_soc/board/DeleteForm?post_id=${dto.post_id }&page=${nowPage }"/>"><button>삭제</button></a>
                    </td>
                    </c:if>
                </tr>
