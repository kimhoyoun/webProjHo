...
.contentBR {
    ...
    <div id="main_wrap">
        <div>
            <h2 id="main_title">축구 대회 게시판 상세보기</h2>
        </div>
        <hr>
            ...
            <table class="table" >
                ...
                <tr>
                    <td class="img" colspan="4">
						...
						<c:forTokens items ="${dto.img }" delims = "," var = "ee" varStatus="no">
							<img src="<c:url value="/uploadFile/commu/soc/compet/${ee}"/>" alt="" style="width: 300px; height: 300px;" />
						</c:forTokens>
						</c:if>
                    </td>
                </tr>
                ...
                <tr>
                    <td class="toList" colspan="2">
                        <a href="<c:url value="/commu_soc/compet/List?page=${nowPage }"/>"><button>목록으로</button></a>
                    </td>
                    <td class="modiNdel" colspan="2">
                    	<c:if test="${User.pid==dto.user_id }">
                    	<a href="<c:url value="/commu_soc/compet/ModifyForm?post_id=${dto.post_id }&page=${nowPage }"/>"><button>수정</button></a>
                    	<a href="<c:url value="/commu_soc/compet/DeleteForm?post_id=${dto.post_id }&page=${nowPage }"/>"><button>삭제</button></a>
                    	</c:if>
                    </td>
                </tr>
