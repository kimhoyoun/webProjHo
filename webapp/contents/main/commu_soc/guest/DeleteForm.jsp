...
<input type="hidden" name = "page" value=${nowPage } />
 ...
 <div><h2 id="main_title">용병 게시글 삭제</h2></div>
      <hr>
      <div id="delete_table">
        ...
        <div class="row" style="margin-top: 10px;">
          <div class="col text-center ">
              <a href="<c:url value="/commu_soc/guest/Detail?post_id=${param.post_id }&page=${nowPage}"/>"><button type="button" class="btn btn-outline-secondary"> 뒤로</button></a>
