...
public class CompetDTO {
	...
	public CompetDTO(String head, String title, String user_id, String post_id, String content, String allfile) {
		this.head = head;
		this.title = title;
		this.user_id = user_id;
		this.post_id = "commu_soc_compet" + System.currentTimeMillis();
	...
	public String toString() {
		return "CompetDTO [cnt=" + cnt + ", post_id=" + post_id + ", head=" + head + ", title=" + title + ", content="
