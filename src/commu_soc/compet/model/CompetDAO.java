package commu_soc.compet.model;
...
public class CompetDAO {
	...
	public int totalCnt() {
		...
		sql = "select count(*) from commu_soc_compet";
	...
	public int totalCntSearch(String search){
		...
		sql = "select count(*) from commu_soc_compet where title like ? ";
	...
	public int totalCntSearch(String field, String search){
		...
		sql = "select count(*) from commu_soc_compet where " + field + " like ? ";
	...
	public CompetDTO detail(String post_id) {
		...
		sql = "select * from commu_soc_compet where post_id =?";
	...
	public void addCount(String post_id) {		
		sql = "update commu_soc_compet set cnt = cnt + 1 where post_id =?";
	...
	public void insert(CompetDTO dto) {	
		...
		sql = "insert into commu_soc_compet (head, title, content, "
	...
	public int delete(CompetDTO dto) {	
		...
		sql = "delete from commu_soc_compet where post_id = ? ";
