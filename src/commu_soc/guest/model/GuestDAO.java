...
public class GuestDAO {
	...
	public int totalCnt() {
		...
		sql = "select count(*) from commu_soc_guest";
	...
	public int totalCntSearch(String search){
		...
		sql = "select count(*) from commu_soc_guest where title like ? ";
	...
	public int totalCntSearch(String field, String search){
		...
		sql = "select count(*) from commu_soc_guest where " + field + " like ? ";
	...
	public GuestDTO detail(String post_id) {
		...
		sql = "select * from commu_soc_guest where post_id =?";
	...
	public void addCount(String post_id) {		
		sql = "update commu_soc_guest set cnt = cnt + 1 where post_id =?";
	...
	public void insert(GuestDTO dto) {	
		...
		sql = "insert into commu_soc_guest (head, title, content, "
	...
	public int modify(GuestDTO dto) {	
		...
		sql = "update commu_soc_guest set head =?, title =?, " + "content=?, upfile=?, img=?,user_id=? "
				+ "where post_id=? ";
	...
	public int delete(GuestDTO dto) {	
		...
		sql = "delete from commu_soc_guest where post_id = ? ";
